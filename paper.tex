...
\includegraphics[width=5.5cm, height=5.5cm]{bubble.png}
\end{comment}
...
\begin{comment}
\subsubsection{Sample Code}
\includegraphics[width=4.35cm, height=4.75cm]{insertion.png}
\end{comment}
